...
import { User, Mail, Shield, Calendar, Settings, ShoppingBag, Heart } from 'lucide-react';
        ...
        <div className="space-y-8">
          ...
          <section className="bg-white rounded-3xl border border-gray-100 p-8 shadow-sm">
            <div className="flex flex-col md:flex-row items-center gap-8 mb-10 pb-10 border-b border-gray-50">
              ...
              <button className="px-6 py-3 rounded-full border border-gray-200 text-sm font-semibold hover:border-gray-950 transition-colors">
                Edit Profile
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-900">{new Date(user.createdAt).toLocaleDateString(undefined, { month: 'long', year: 'numeric' })}</p>
                </div>
              </div>
            </div>
          </section>
